...
public class ReducerJoin {
	...
	public static class CustsMapper extends
		...
		public void map(Object key, Text value, Context context)
			...
			System.out.println("in custs mapp");
	...
	public static class TxnsMapper extends
		...
		public void map(Object key, Text value, Context context)
				throws IOException, InterruptedException {
			System.out.println("in txns mapp");
			String record = value.toString();
			String[] parts = record.split(",");
	...
	public static class ReduceJoinReducer extends
		...
		public void reduce(Text key, Iterable<Text> values, Context context)
			...
			for (Text t : values) {
				...
				System.out.println("in reducer"+name);
			}
	...
	public static void main(String[] args) throws Exception {
		...
		MultipleInputs.addInputPath(job, new Path("/home/oodles/input/cust"),TextInputFormat.class, CustsMapper.class);
		MultipleInputs.addInputPath(job, new Path("/home/oodles/input/trns"),TextInputFormat.class, TxnsMapper.class);
